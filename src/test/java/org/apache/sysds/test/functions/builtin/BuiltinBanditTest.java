...
public class BuiltinBanditTest extends AutomatedTestBase {
	...
	public void testBandit1CP() {
		runBanditTest( 5, LopProperties.ExecType.CP);
	}

	@Test
	public void testBandit3CP() {
		runBanditTest( 2, LopProperties.ExecType.CP);
	}

	private void runBanditTest( Integer k, LopProperties.ExecType et) {
		...
		try {
			...
			programArgs = new String[] {"-stats", "-args", DATASET, PRIMITIVES, PARAM,
