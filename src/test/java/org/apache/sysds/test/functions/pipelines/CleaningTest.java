...
public class CleaningTest extends AutomatedTestBase {
	...
	@Test
	public void testCP() {
		runCleaningTest( LopProperties.ExecType.CP);
	}
	...
	private void runCleaningTest(LopProperties.ExecType et) {
		...
		try {
			...
			programArgs = new String[] {"-stats", "-args", DATASET, META, PRIMITIVES, PARAM, output("R")};
